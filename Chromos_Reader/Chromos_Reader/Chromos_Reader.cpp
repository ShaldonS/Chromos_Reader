...
// Chromos_Reader.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CChromosReaderApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CChromosReaderApp

CChromosReaderApp::CChromosReaderApp()
{
...
// Единственный объект CChromosReaderApp

CChromosReaderApp theApp;


// Инициализация CChromosReaderApp

BOOL CChromosReaderApp::InitInstance()
{
